...
if ($verified) {
    ...
    */
	...
	mysql_connect("mysql.byondpanel.com", "paypal", "JxyYYe6YbYtqppwB") or die(mysql_error());
	mysql_select_db("paypal_payments") or die(mysql_error());
